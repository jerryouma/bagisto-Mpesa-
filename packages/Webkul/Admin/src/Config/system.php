...
return [
    ...
    [
        ...
        'name'   => 'admin::app.configuration.index.sales.payment-methods.mpesa',
        'info'   => 'admin::app.configuration.index.sales.payment-methods.mpesa-info',
        'sort'   => 3,
        'fields' => [
            [
                'name'          => 'title',
                ...
                'title'         => 'admin::app.configuration.index.sales.payment-methods.business-short-code',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name'          => 'passkey',
                'title'         => 'admin::app.configuration.index.sales.payment-methods.passkey',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
